...
public class Transaksi {
    ...
    public Transaksi(
        ...
        this.catatanKondisi = catatanKondisi;
        this.fotoKondisiUrl = fotoKondisiUrl;
    }
    ...
    public String getCatatanKondisi() {
    return catatanKondisi;
}

    public String getFotoKondisiUrl() {
        return fotoKondisiUrl;
    }
}
